document.addEventListener('DOMContentLoaded', function() {
  ...
  var signupContainer = document.querySelector('.SignupFormContainer');
  
  var toggleButtons = document.querySelectorAll('.ToggleBtn');

  var logoContainer = document.querySelector('.LogoContainer');
  var loginHeader = document.querySelector('.header');
  var signupHeader = document.querySelector('.signInHeader');
